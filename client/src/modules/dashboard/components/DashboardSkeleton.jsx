    ...
    <div className="w-full space-y-6 animate-pulse">
      ...
      <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <div className="h-10 w-64 bg-gray-200 dark:bg-slate-700 rounded"></div>
        </div>
      ...
      <div className="grid gap-4 sm:gap-6 md:grid-cols-3 grid-cols-1">
        {Array.from({ length: 3 }).map((_, i) => (
          ...
          >
            ...
            <div className="h-3 w-32 bg-gray-300 dark:bg-slate-800 rounded"></div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-2xl border bg-gray-100 dark:bg-slate-900/50 overflow-hidden">
            <div className="p-6 flex items-center gap-3 border-b border-gray-200 dark:border-border">
            ...
            <div className="p-6 h-72 flex items-center justify-center">
              <div className="w-full h-full bg-gray-300 dark:bg-slate-800 rounded"></div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-gray-100 dark:bg-slate-900/50 overflow-hidden">
            ...
            <div className="p-6 h-72 bg-gray-300 dark:bg-slate-800 rounded"></div>
          </div>
          ...
          <div className="rounded-2xl border bg-gray-100 dark:bg-slate-900/50 p-6">
            ...
            <div className="space-y-3">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="h-4 w-full bg-gray-300 dark:bg-slate-800 rounded"></div>
              ))}
              <div className="h-4 w-3/4 bg-gray-300 dark:bg-slate-800 rounded"></div>
            </div>
          </div>
        </div>
